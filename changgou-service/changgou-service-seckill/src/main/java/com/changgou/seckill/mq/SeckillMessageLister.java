        ...
        if (allMap != null) {
            ...
            if ("SUCCESS".equalsIgnoreCase(return_code)) {
                ...
                if ("SUCCESS".equalsIgnoreCase(result_code)) {
                    ...
                    SeckillGoods seckillGoods = (SeckillGoods) redisTemplate.boundHashOps(SystemConstants.SEC_KILL_GOODS_PREFIX + seckillStatus.getTime()).get(seckillOrder.getSeckillId().toString());
                    ...
                    redisTemplate.boundHashOps(SystemConstants.SEC_KILL_GOODS_PREFIX + seckillStatus.getTime()).put(seckillGoods.getId().toString(), seckillGoods);
